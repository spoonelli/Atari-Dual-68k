...
- Schematic says 68010; we followed MAME and built TG68K CPU="00" (68000) anyway.
  *(Corrected 2026-08-24: the board really is a 68010 — `MC68010P8`, date code
  `A71R8813`, photographed. The "real boards carry 68000s (photo-verified)" claim
  that stood here was false, and there was never a photo. See CPU_AND_ARBITER.md.)*
...
- MAME + schematics + disassembly agree or someone is wrong — the "+5V" pins
  ...
  the measurement being right. The 68010 label was **not**: the schematic was
  right all along and a casual board inspection, written up without a photo,
  overturned it for two weeks. The lesson cuts both ways — an unrecorded
  observation is not a measurement, and "the docs are wrong" is a claim that
  needs the same evidence bar as any other.
