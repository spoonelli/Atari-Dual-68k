...
synch_3 s_mopri(m_mopri_px, m_mopri_sd, clk_sdram);
    ...
    // PFEXTRACT-120: moved VERBATIM to src/fpga/core/rtl/escape_pf.v so a bench
    // can drive the SHIPPED instance. It lived here, and nothing compiles this
    // file - which is why the left-edge strip absorbed two fixes that no test
    // could contradict. Same treatment escape_stain.v got.
